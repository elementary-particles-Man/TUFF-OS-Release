...
pub mod aitcp {
    ...
    impl<'a> AITcpPacket<'a> {
        ...
        >(
            ...
            if let Some(x) = args.footer {
                builder.add_footer(x);
            }
            ...
            if let Some(x) = args.encrypted_payload {
                builder.add_encrypted_payload(x);
            }
            if let Some(x) = args.encrypted_sequence_id {
                builder.add_encrypted_sequence_id(x);
            }
            if let Some(x) = args.nonce {
                builder.add_nonce(x);
            }
            if let Some(x) = args.ephemeral_key {
                builder.add_ephemeral_key(x);
            }
        ...
        pub fn version(&self) -> u8 {
            ...
            unsafe {
                self._tab
                    .get::<u8>(AITcpPacket::VT_VERSION, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        ...
        pub fn encrypted_sequence_id(&self) -> flatbuffers::Vector<'a, u8> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
                        AITcpPacket::VT_ENCRYPTED_SEQUENCE_ID,
                        None,
                    )
                    .unwrap()
            }
        ...
        pub fn encrypted_payload(&self) -> flatbuffers::Vector<'a, u8> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
                        AITcpPacket::VT_ENCRYPTED_PAYLOAD,
                        None,
                    )
                    .unwrap()
            }
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(
                    ...
                    Self::VT_ENCRYPTED_SEQUENCE_ID,
                    true,
                )?
                .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(
                    "encrypted_payload",
                    Self::VT_ENCRYPTED_PAYLOAD,
                    true,
                )?
                .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>(
                    "signature",
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> AITcpPacketBuilder<'a, 'b, A> {
        ...
        pub fn add_version(&mut self, version: u8) {
            self.fbb_
                .push_slot::<u8>(AITcpPacket::VT_VERSION, version, 0);
        }
        #[inline]
        pub fn add_ephemeral_key(
            &mut self,
            ephemeral_key: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>,
        ) {
        ...
        pub fn add_nonce(&mut self, nonce: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(AITcpPacket::VT_NONCE, nonce);
        }
        #[inline]
        pub fn add_encrypted_sequence_id(
            &mut self,
            encrypted_sequence_id: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                AITcpPacket::VT_ENCRYPTED_SEQUENCE_ID,
                encrypted_sequence_id,
        ...
        pub fn add_encrypted_payload(
            &mut self,
            encrypted_payload: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                AITcpPacket::VT_ENCRYPTED_PAYLOAD,
                encrypted_payload,
        ...
        pub fn add_header(&mut self, header: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(AITcpPacket::VT_HEADER, header);
        }
        #[inline]
        pub fn add_payload(
            &mut self,
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(AITcpPacket::VT_PAYLOAD, payload);
        }
        #[inline]
        pub fn add_footer(&mut self, footer: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(AITcpPacket::VT_FOOTER, footer);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> AITcpPacketBuilder<'a, 'b, A> {
        ...
        pub fn finish(self) -> flatbuffers::WIPOffset<AITcpPacket<'a>> {
            ...
            self.fbb_
                .required(o, AITcpPacket::VT_EPHEMERAL_KEY, "ephemeral_key");
            ...
            self.fbb_
                .required(o, AITcpPacket::VT_ENCRYPTED_PAYLOAD, "encrypted_payload");
            self.fbb_
                .required(o, AITcpPacket::VT_SIGNATURE, "signature");
    ...
    pub fn size_prefixed_root_as_aitcp_packet(
        buf: &[u8],
    ) -> Result<AITcpPacket, flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_aitcp_packet_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
        fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        root: flatbuffers::WIPOffset<AITcpPacket<'a>>,
    ) {
