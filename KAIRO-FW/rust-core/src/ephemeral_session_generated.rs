...
pub mod aitcp {
    ...
    impl<'a> EphemeralSession<'a> {
        ...
        pub fn session_id(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    EphemeralSession::VT_SESSION_ID,
                    None,
                )
            }
        }
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
                        EphemeralSession::VT_PUBLIC_KEY,
                        None,
                    )
            }
        }
        ...
        pub fn expiration_unix(&self) -> i64 {
            ...
            unsafe {
                self._tab
                    .get::<i64>(EphemeralSession::VT_EXPIRATION_UNIX, Some(0))
                    .unwrap()
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> EphemeralSessionBuilder<'a, 'b, A> {
        ...
        pub fn add_expiration_unix(&mut self, expiration_unix: i64) {
            self.fbb_
                .push_slot::<i64>(EphemeralSession::VT_EXPIRATION_UNIX, expiration_unix, 0);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> EphemeralSessionBuilder<'a, 'b, A> {
    ...
    pub fn root_as_ephemeral_session(
        buf: &[u8],
    ) -> Result<EphemeralSession, flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_ephemeral_session(
        buf: &[u8],
    ) -> Result<EphemeralSession, flatbuffers::InvalidFlatbuffer> {
    ...
    pub unsafe fn size_prefixed_root_as_ephemeral_session_unchecked(
        buf: &[u8],
    ) -> EphemeralSession {
    ...
    #[inline]
    pub fn finish_size_prefixed_ephemeral_session_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
        fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        root: flatbuffers::WIPOffset<EphemeralSession<'a>>,
    ) {
